...
import com.liser.common.exception.SysLevelException;
...
public class DateUtil extends DateUtils {
    ...
    public static String toTimeString(int hour, int minute, int second) {
        ...
        if (second == 0)
            return (new StringBuilder(String.valueOf(hourStr))).append(":").append(minuteStr).toString();
        else
            return (new StringBuilder(String.valueOf(hourStr))).append(":").append(minuteStr).append(":").append(secondStr).toString();
    }

    public static String toTimeString(byte year, byte month, byte day, byte hour, byte minute, byte second) {
        String yearStr;
        if(year < 10)
            yearStr = (new StringBuilder("200")).append(year).toString();
        else
            yearStr = (new StringBuilder("20")).append(year).toString();
        String monthStr;
        if(month < 10)
        ...
        return (new StringBuilder(String.valueOf(yearStr))).append("-").append(monthStr).append("-").append(dayStr)
                .append(" ").append(hourStr).append(":").append(minuteStr).append(":").append(secondStr).toString();
    ...
    public static boolean isYear(String year) {
        ...
        if (year.length() != 4)
            return false;
        return StringUtil.isNumeric(year);
    }
    ...
    public static boolean isMinute(String minute) {
        ...
        if (minute.length() != 1 && minute.length() != 2)
            return false;
        if (!StringUtil.isNumeric(minute))
            return false;
        int iMinute = Integer.parseInt(minute);
    ...
    public static boolean isSecond(String second) {
        ...
        if (second.length() != 1 && second.length() != 2)
            return false;
        if (!StringUtil.isNumeric(second))
            return false;
        int iSecond = Integer.parseInt(second);
